...
const GREETING =
  'Hola, soy Lucía, tu consultora de obra. Te hago unas preguntas rápidas y te digo, con tus números, qué te está costando el papeleo. Y si esto te encaja o no, te lo diré claro. ' +
