...
date: "2026-07-13"
status: published
review: approved 2026-07-12T17:04:02.545Z
silo: "B"
type: "escalable"
plan_row: 2
target_keyword: "Verifactu IVA 10% reformas factura"
allintitle_revalidado: "0 (revalidado 2026-06-23)"
meta_description: "Para facturar una reforma al 10% de IVA con Verifactu necesitas cumplir 3 requisitos y dejarlo claro en la factura. Te cuento cuáles, sin líos."
ymyl: true               # fiscal → requiere revisión humana de datos antes de publicar
schema: "FAQ"
imagen_sugerida: "Primer plano de una factura de reforma en papel con el desglose de material y mano de obra y el 10% de IVA marcado, sobre una mesa con un metro y un lápiz de obra."
imagen_alt: "Factura de reforma con IVA reducido del 10% y desglose de materiales y mano de obra"
imagen: "images/verifactu-iva-10-reformas.webp"
---
...
| Requisito | En cristiano | Fuente |
|---|---|---|
| Quién recibe la obra | Un **particular** que usa esa vivienda para vivir (no una empresa, no un local, no un piso turístico) | Ley 37/1992, art. 91.Uno.2.10º |
| Antigüedad de la vivienda | La casa tiene **más de 2 años** desde que se construyó o desde la última gran rehabilitación | Ley 37/1992, art. 91.Uno.2.10º |
| Material que pones tú | Lo que cuesta el **material** que aportas tú **no pasa del 40%** de la base de la factura | Consulta DGT V0860-24; Ley 37/1992 |
...
| Quién | Desde cuándo es obligatorio | Fuente |
|---|---|---|
...
| 2026 | Año de transición (puedes adaptarte ya, voluntario) | AEAT, nota informativa de ampliación de plazos |
...
- → [IVA del 10% o del 21% en una reforma: cómo saber cuál poner](/iva-10-21-reformas) *(fila #26, planificado)*
- → [Verifactu para autónomos de reformas: guía 2027 oficio por oficio](/verifactu-autonomos-reformas-guia-2027) *(fila #1, planificado)*
...
```json
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Cuándo se aplica el 10% de IVA en una reforma?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Cuando se cumplen tres requisitos a la vez: el destinatario es un particular que usa la vivienda para vivir, la vivienda tiene más de 2 años, y el material aportado por quien hace la obra no supera el 40% de la base imponible de la factura. Si falla uno, toda la obra tributa al 21%."
      }
    },
    {
      "@type": "Question",
      "name": "¿Verifactu cambia el IVA que aplico en mis reformas?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No cambia cuándo se aplica el 10%, pero hace que Hacienda pueda verificar cada factura casi en tiempo real. Un tipo de IVA mal aplicado se detecta antes, así que el 10% debe quedar bien justificado en la factura. Verifactu es obligatorio para autónomos desde el 1 de julio de 2027."
      }
    },
    {
      "@type": "Question",
      "name": "¿Qué debe incluir la factura para aplicar el 10% en una reforma?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "La mención expresa al artículo 91.Uno.2.10º de la Ley 37/1992, el desglose separado de material y mano de obra para comprobar la regla del 40%, y una declaración firmada por el cliente confirmando que la vivienda es suya, de uso particular y de más de 2 años. Además, los datos completos del cliente (nombre y NIF/DNI)."
      }
    },
    {
      "@type": "Question",
      "name": "¿Qué pasa si aplico mal el 10% de IVA en una reforma?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Hacienda puede reclamar la diferencia hasta el 21% sobre el total de la obra, más recargos. Y usar un programa de facturación que no cumpla Verifactu puede acarrear sanciones de hasta 50.000 euros por ejercicio."
      }
    }
  ]
}
...
- [x] Datos verificados contra fuente oficial (YMYL): Ley 37/1992 art. 91, DGT V0860-24, AEAT Verifactu, RD 1007/2023 + RD-ley 15/2025.
- [x] Voz del ICP (registro B + vocabulario de Manuel) + IA invisible (no aparece "IA/software/plataforma" en titular ni CTA).
- [x] Pasada anti-IA hecha (sin "no solo X sino Y", sin "en la era de", sin cierres vacíos).
- [x] allintitle revalidado 2026-06-23 → 0 (océano azul).
- [ ] PENDIENTE HUMANO: confirmar el enlace real de "Pruébalo gratis" (ahora #) y las URLs internas cuando se publiquen los pilares.
- [ ] PENDIENTE HUMANO (YMYL): que una persona valide los datos fiscales antes de publicar. Revisar caso de módulos/recargo de equivalencia aparte (no tratado aquí).
-->
